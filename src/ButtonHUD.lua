...
function script.onFlush()
    ...
    -- validate params
    pitchSpeedFactor = math.max(pitchSpeedFactor or 0.01, 0.01)
    yawSpeedFactor = math.max(yawSpeedFactor or 0.01, 0.01)
    rollSpeedFactor = math.max(rollSpeedFactor or 0.01, 0.01)
    torqueFactor = math.max(torqueFactor or 0.01, 0.01)
    brakeSpeedFactor = math.max(brakeSpeedFactor or 0.01, 0.01)
    brakeFlatFactor = math.max(brakeFlatFactor or 0.01, 0.01)
    autoRollFactor = math.max(autoRollFactor or 0.01, 0.01)
    turnAssistFactor = math.max(turnAssistFactor or 0.01, 0.01)
